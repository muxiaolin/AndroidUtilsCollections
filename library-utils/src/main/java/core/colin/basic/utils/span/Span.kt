...
class Span(source: CharSequence?) : SpannableString(source ?: "") {
    ...
    fun setImage(
        ...
        setOneSpanAll(
            if (source == null) ImageSpan(drawable, verticalAlignment) else ImageSpan(
                drawable,
                source,
                verticalAlignment
            )
     ...
     */
    fun setImage(drawable: Drawable, verticalAlignment: Int) =
        setImage(drawable, null, verticalAlignment)
