 ...
 * @date 2018/9/20
 */
public class ViewCountDownTimer<V extends View> implements SecondCountDownTimer.OnTimerTickListener,
        SecondCountDownTimer.OnTimerStartListener, SecondCountDownTimer.OnTimerFinishListener {
