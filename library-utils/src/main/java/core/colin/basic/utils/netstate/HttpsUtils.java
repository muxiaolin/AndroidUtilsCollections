...
public class HttpsUtils {
    ...
    public static String createUrlFromParam(String url, Map<String, String> params) {
        ...
        if (params != null && !params.isEmpty()) {
            for (Map.Entry<String, String> urlParams : params.entrySet()) {
                ...
                sb.append(urlParams.getKey()).append("=").append(URLEncoder(urlParams.getValue())).append("&");
            }
        }
    ...
    public static String createUrlFromParamList(String url, Map<String, List<String>> params) {
        StringBuilder sb = new StringBuilder();
        sb.append(url);
        if (url.indexOf('&') > 0 || url.indexOf('?') > 0) {
            sb.append("&");
            ...
            for (Map.Entry<String, List<String>> urlParams : params.entrySet()) {
                ...
                if (urlValues != null && !urlValues.isEmpty()) {
                    for (String value : urlValues) {
                        //对参数进行 utf-8 编码,防止头信息传中文
                        sb.append(urlParams.getKey()).append("=").append(URLEncoder(value)).append("&");
                    }
                }
            }
        }
