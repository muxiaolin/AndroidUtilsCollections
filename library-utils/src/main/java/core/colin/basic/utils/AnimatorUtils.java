...
public class AnimatorUtils {
     ...
     * @param targetView
     */
    public static void smoothScrollTo(NestedScrollView scrollView, View targetView) {
        smoothScrollTo(scrollView, targetView, 0);
    }
     ...
     * @param targetView
     */
    public static void smoothScrollTo(NestedScrollView scrollView, View targetView, int offset) {
        if (targetView == null || scrollView == null) {
            return;
        }
        int[] location = new int[2];
        targetView.getLocationOnScreen(location);
//        Log.d("scroll", "targetView location = " + Arrays.toString(location));
        int[] scrollLocation = new int[2];
        scrollView.getLocationOnScreen(scrollLocation);
//        Log.d("scroll", "scrollView location = " + Arrays.toString(scrollLocation));
//        int scrollY = scrollView.getScrollY();
//        Log.d("scroll", "scrollView scrollY = " + scrollY);
        scrollView.smoothScrollBy(0, location[1] - scrollLocation[1] + offset, 1500);
    }
    ...
    public static void changeViewHeight(final View view, int height, long duration, TimeInterpolator interpolator) {
        changeViewHeight(view, height, duration, interpolator, null);
    }
     ...
     * @param duration 时长
     */
    public static void changeViewHeight(final View view, int height, long duration, TimeInterpolator interpolator, Animator.AnimatorListener listener) {
    ...
    public static void changeViewBgColor(final View view, final int colorFrom, final int colorTo, long duration, TimeInterpolator interpolator) {
        ...
        valueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animator) {
                float f = (float) animator.getAnimatedValue();
                view.setBackgroundColor(DisplayUtils.changingColor(colorFrom, colorTo, f));
            }
        });
        valueAnimator.start();
    }
    ...
    public static void flipVertical(final View target, final View oldView, final View newView, final long time, final float cameraDistance,
    ...
    public static void animateExpanded(View view, boolean isExpanded, ViewPropertyAnimatorListenerAdapter listener) {
    ...
    public static void animateExpanded(View view, boolean isAnimate, boolean isExpanded) {
        if (isAnimate) {
            ViewCompat.animate(view)
                    .setDuration(200)
                    .setInterpolator(new DecelerateInterpolator())
