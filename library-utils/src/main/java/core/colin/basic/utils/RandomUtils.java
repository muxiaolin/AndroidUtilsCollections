 ...
 * <ul>
 * Shuffling algorithm
 * <li>{@link #shuffle(Object[])} Shuffling algorithm, Randomly permutes the specified array using a
 * default source of randomness</li>
 ...
 * a default source of randomness</li>
 ...
 * <li>{@link #getRandomCapitalLetters(int)} get a fixed-length random string, its a mixture of
 * uppercase letters</li>
 * <li>{@link #getRandomLetters(int)} get a fixed-length random string, its a mixture of uppercase
 * and lowercase letters</li>
 * <li>{@link #getRandomLowerCaseLetters(int)} get a fixed-length random string, its a mixture of
 ...
 * uppercase, lowercase letters and numbers</li>
 * <li>{@link #getRandom(String, int)} get a fixed-length random string, its a mixture of chars in
 * source</li>
 * <li>{@link #getRandom(char[], int)} get a fixed-length random string, its a mixture of chars in
 * sourceChar</li>
 * </ul>
 */
public class RandomUtils {
    ...
    public static final String NUMBERS_AND_LOWER_CASE_LETTERS = "0123456789abcdefghijklmnopqrstuvwxyz";
    public static final String NUMBERS_AND_CAPITAL_LETTERS = "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ";
     ...
     */
    public static String getRandomNumbersAndLowerCaseLetters(int length) {
        return getRandom(NUMBERS_AND_LOWER_CASE_LETTERS, length);
    }
     ...
     * @see RandomUtils#getRandom(String source, int length)
     */
    public static String getRandomNumbersAndCapitalLetters(int length) {
        return getRandom(NUMBERS_AND_CAPITAL_LETTERS, length);
    }
